!function(e, a) {
    ...
    var values = [ [ "1-1 Value", "1-2 Value", "1-3 Value", "1-4 Value", "1-5 Value" ], [ "2-1 Value", "2-2 Value", "2-3 Value", "2-4 Value", "2-5 Value" ], [ "3-1 Value", "3-2 Value", "3-3 Value", "3-4 Value", "3-5 Value" ], [ "4-1 Value", "4-2 Value", "4-3 Value", "4-4 Value", "4-5 Value" ], [ "5-1 Value", "5-2 Value", "5-3 Value", "5-4 Value", "5-5 Value" ], [ "6-1 Value", "6-2 Value", "6-3 Value", "6-4 Value", "6-5 Value" ] ], backgrounds = [ [ "#E5E5E5", "#E5E5E5", "#E5E5E5", "#E5E5E5", "#E5E5E5" ], [ "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF" ], [ "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF" ], [ "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF" ], [ "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF" ], [ "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF" ] ], fontcolors = [ [ "#000000", "#000000", "#000000", "#000000", "#000000" ], [ "#000000", "#000000", "#000000", "#000000", "#000000" ], [ "#000000", "#000000", "#000000", "#000000", "#000000" ], [ "#000000", "#000000", "#000000", "#000000", "#000000" ], [ "#000000", "#000000", "#000000", "#000000", "#000000" ], [ "#000000", "#000000", "#000000", "#000000", "#000000" ] ], notes = [ [ "", "", "", "", "" ], [ "", "", "HEADER_ANCHOR", "", "" ], [ "", "", "", "", "" ], [ "", "", "", "", "" ], [ "", "", "", "", "" ], [ "", "", "", "", "" ] ], fontweights = [ [ "bold", "bold", "bold", "bold", "bold" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ] ], fontstyles = [ [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ], [ "normal", "normal", "normal", "normal", "normal" ] ], fontsizes = [ [ 12, 12, 12, 12, 12 ], [ 10, 10, 10, 10, 10 ], [ 10, 10, 10, 10, 10 ], [ 10, 10, 10, 10, 10 ], [ 10, 10, 10, 10, 10 ], [ 10, 10, 10, 10, 10 ] ], fontfamilies = [ [ "Arial", "Arial", "Arial", "Arial", "Arial" ], [ "Arial", "Arial", "Arial", "Arial", "Arial" ], [ "Arial", "Arial", "Arial", "Arial", "Arial" ], [ "Arial", "Arial", "Arial", "Arial", "Arial" ], [ "Arial", "Arial", "Arial", "Arial", "Arial" ], [ "Arial", "Arial", "Arial", "Arial", "Arial" ] ], DataContainer = function() {
        ...
        return _createClass(DataContainer, [ {
            ...
            value: function(dataArrayName, startRow, startColumn, numRows, numColumns) {
                ...
                if (!Number.isInteger(startRow)) throw new Error("startRow must be an integer - received ".concat(startRow, "."));
                if (!Number.isInteger(startColumn)) throw new Error("startColumn must be an integer - received ".concat(startColumn, "."));
                var numRowsClean, numColumnsClean, dataArray = this[dataArrayName];
                if (numRows === undefined && numColumns === undefined ? numColumnsClean = numRowsClean = 1 : numRows !== undefined && numColumns === undefined && (numColumnsClean = dataArray[0].length + 1 - startColumn), 
                startRow < 1 || startRow > dataArray.length) throw new Error("startRow out of range for ".concat(dataArrayName, ". Requested startRow ").concat(startRow, " - must be between 1 and ").concat(dataArray.length, "."));
    ...
    (function SheetAccessor(sheet, headerAnchorToken) {
        var _this = this;
        !function sheet_accessor_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        ...
        this.fontweight = {}, this.headerAnchorToken = "HEADER_ANCHOR", this.headerRowIndex = 0, 
        this.headerColumnIndex = 0, this.getHeaderRow = null, this.getAllRecordIndices = null, 
    ...
    function unique_set_defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];
            descriptor.enumerable = descriptor.enumerable || !1, descriptor.configurable = !0, 
            "value" in descriptor && (descriptor.writable = !0), Object.defineProperty(target, descriptor.key, descriptor);
    ...
    var UniqueSet = function() {
        function UniqueSet() {
            ...
            !function unique_set_classCallCheck(instance, Constructor) {
                if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
            }(this, UniqueSet), this.strings = {}, this.numbers = {}, this.dates = {}, Object.keys(args).forEach(function(i) {
                _this.push(args[i]);
            });
        }
        return function unique_set_createClass(Constructor, protoProps, staticProps) {
            return protoProps && unique_set_defineProperties(Constructor.prototype, protoProps), 
            staticProps && unique_set_defineProperties(Constructor, staticProps), Constructor;
        }(UniqueSet, [ {
            key: "push",
            value: function(input) {
    ...
    function query_driver_defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];
            descriptor.enumerable = descriptor.enumerable || !1, descriptor.configurable = !0, 
            "value" in descriptor && (descriptor.writable = !0), Object.defineProperty(target, descriptor.key, descriptor);
    ...
    var query_driver_QueryDriver = function() {
        function QueryDriver(query, type) {
            !function query_driver_classCallCheck(instance, Constructor) {
                if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
            }(this, QueryDriver), this.query = null, this.type = type.toUpperCase(), this.writeToCursor = !1, 
            this.withRecords = !1, this.requestedAttributes = new UniqueSet(), this.loadQuery(query);
        }
        return function query_driver_createClass(Constructor, protoProps, staticProps) {
            return protoProps && query_driver_defineProperties(Constructor.prototype, protoProps), 
            staticProps && query_driver_defineProperties(Constructor, staticProps), Constructor;
        }(QueryDriver, [ {
            key: "loadQuery",
            value: function(query) {
                ...
                SUPPORTED_ATTRIBUTES.forEach(function(attribute) {
    ...
    }(), getTimeStamp = (function isString(input) {
        return "[object String]" === toString.call(input);
    }, function getTimeStamp(precision) {
    ...
    var query_return_QueryReturn = function() {
        function QueryReturn(queryDriver) {
            ...
            this.query = queryDriver.query, this.type = queryDriver.type, this.resultSet = new UniqueSet(), 
            this.queryStartTime = getTimeStamp(), this.queryDuration = null, this.returnContainer = {
                records: {},
                errors: []
            };
        }
        return function query_return_createClass(Constructor, protoProps, staticProps) {
            ...
            key: "done",
            value: function() {
                this.queryDuration = getTimeDiff(this.queryStartTime), Logger.log("".concat(this.type, " operation completed in ").concat(this.queryDuration, " ms.\n ").concat(this.query.toString()));
            }
        }, {
            key: "count",
            get: function() {
    ...
    }(), src_sheet = spreadsheet_simulator.getActiveSpreadsheet().getSheetByName("Test"), sheetAccessor = new function SheetAccessor(sheet, headerAnchorToken) {
        var _this = this;
        !function sheet_accessor_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }(this, SheetAccessor), this.range = {}, this.value = {}, this.background = {}, 
    ...
    }(src_sheet), src_queryDriver = new query_driver_QueryDriver(function(r) {
        var balls = 1;
        return r.nuggets.value === r.nuggets.fontcolor && (balls = 5), balls;
    }, "test"), queryReturn = new query_return_QueryReturn(src_queryDriver);
    Logger.log(JSON.stringify(src_sheet)), Logger.log(JSON.stringify(sheetAccessor)), 
    Logger.log(JSON.stringify(src_queryDriver)), Logger.log(JSON.stringify(queryReturn));
} ]));