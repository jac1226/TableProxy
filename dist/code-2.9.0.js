function doGet() {
    ...
    var _unique_set__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2), _CONSTANTS__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
    ...
    }, unique_set = __webpack_require__(2), query_driver = __webpack_require__(1);
    function _defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];
            descriptor.enumerable = descriptor.enumerable || !1, descriptor.configurable = !0, 
    ...
    __webpack_require__.d(__webpack_exports__, "a", function() {
        return query_return_QueryReturn;
    });
    ...
    __webpack_require__.r(__webpack_exports__), function(global) {
        var _spreadsheet_simulator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3), _sheet_accessor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4), _query_driver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1), _query_return__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5), doGet = function doGet() {
            var sheet = _spreadsheet_simulator__WEBPACK_IMPORTED_MODULE_0__["a"].getActiveSpreadsheet().getSheetByName("Test"), sheetAccessor = new _sheet_accessor__WEBPACK_IMPORTED_MODULE_1__["a"](sheet), query = function query(r) {
                var balls = 1;
                return r.nuggets.value === r.nuggets.fontcolor && (balls = 5), balls;
            }, queryDriver = new _query_driver__WEBPACK_IMPORTED_MODULE_2__["a"](query, "test"), output = {
                sheet: sheet,
                sheetAccessor: sheetAccessor,
                queryDriver: queryDriver,
                queryReturn: new _query_return__WEBPACK_IMPORTED_MODULE_3__["a"](queryDriver)
            };
