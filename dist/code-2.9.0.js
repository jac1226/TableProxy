...
function sendmail() {
    ...
    var UniqueSet = function() {
        ...
        return function _createClass(Constructor, protoProps, staticProps) {
            ...
            value: function(input) {
                ...
                return ("[object Array]" === inputType ? input : [ input ]).forEach(function(item, index) {
                    switch (toString.call(item)) {
                      case "[object Number]":
                        _this2.numbers[item] = Number;
                        break;

                      case "[object String]":
                        _this2.strings[item] = String;
                        break;

                      case "[object Date]":
                        _this2.dates[item] = Date;
                        break;
            ...
            value: function(input) {
                ...
                return ("[object Array]" === inputType ? input : [ input ]).forEach(function(item, index) {
                    switch (toString.call(item)) {
                      case "[object Number]":
                        delete _this3.numbers[item];
                        break;

                      case "[object String]":
                        delete _this3.strings[item];
                        break;

                      case "[object Date]":
                        delete _this3.dates[item];
                        break;
            ...
            get: function() {
                var _this4 = this;
                return [].concat(Object.keys(this.numbers).map(function(item) {
                    return _this4.numbers[item](item);
                })).concat(Object.keys(this.strings).map(function(item) {
                    return _this4.strings[item](item);
                })).concat(Object.keys(this.dates).map(function(item) {
                    return _this4.dates[item](item);
                }));
            }
        }, {
            key: "contains",
    ...
    }(), u = new UniqueSet(1, 2, 3, 4, 5, 5, 5, 5, "1");
    Logger.log(JSON.stringify(u));
}, function(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    __webpack_require__.r(__webpack_exports__), function(global) {
        var _server_webapp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0), _unique_set__WEBPACK_IMPORTED_MODULE_2__ = (__webpack_require__(12), 
        ...
        var u = new _unique_set__WEBPACK_IMPORTED_MODULE_2__["a"](1, 2, 3, 4, 4, 4, 4);
        Logger.log(JSON.stringify(u));
